...
if %hpp%==CUDA (
    ...
    cl.exe /c /EHsc /std:c++20 /I "C:\OCL_SDK_Light\include" /I ".\include" src/main.cpp src/GPU/OpenCL/openclProperties.cpp src/common/imageFunctions.cpp src/CPU/changeDetection.cpp src/CPU/imageOperations.cpp
