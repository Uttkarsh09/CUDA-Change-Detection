...
if %hpp%==CUDA (
    ...
    @REM nvcc.exe -std c++20 -c -o "./bin/cudaChangeDetection.obj" src/GPU/CUDA/cudaChangeDetection.cu
    @REM nvcc.exe -std c++20 -c -o "./bin/cudaChangeDetectionKernel.obj" src/GPU/CUDA/changeDetectionKernel.cu
    @REM cd "./bin/"
    ...
    @REM link.exe /LIBPATH:"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v12.0\lib\x64" /LIBPATH:"../lib" main.obj imageFunctions.obj changeDetection.obj imageOperations.obj cudaChangeDetection.obj cudaChangeDetectionKernel.obj
