...
if %hpp%==CUDA (
    ...
    nvcc.exe -c -o "./bin/cudaProperties.obj" src/GPU/CUDA/cudaProperties.cu
    cd "./bin/"
    ...
    link.exe /LIBPATH:"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v12.0\lib\x64" /LIBPATH:"../lib" main.obj imageFunctions.obj changeDetection.obj imageOperations.obj cudaProperties.obj
    @copy main.exe "../" > nul
    cd ../
    main.exe
